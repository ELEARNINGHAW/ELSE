...
<div style="float:left; position: absolute; background-color: #FBFBFB;  height: auto; margin-left: 15px; margin-right: 15px; padding-bottom:150px; border-left: #FBFBFB 50px solid; border-right: #FBFBFB 50px solid;  border-bottom:black solid 1px;">
<div class="column">
