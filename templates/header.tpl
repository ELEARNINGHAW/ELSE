...
{if  ($SEMESTER != null) }
  <ul id="nav" style="position:absolute; left:320px;   top:3px; margin-right:10px; border: white solid 2px;">
...
<ul id="nav2" style="position:absolute; left:580px;   top:1px;">
    {if      $filter.state ==  0 AND $filter.type != 99}  <li><a class="bo"  href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterState&amp;category=0"  title="Alle SemApp"         ><img src="img/svg/Xa.svg" width="32" height="32"/></a>
    ...
    {elseif  $filter.type  == 99}                         <li><a class="bo"  href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterType&amp;category=99"  title="Erwerbungsvorschlag" ><img src="img/svg/Ka.svg" width="32" height="32"/></a>
    {elseif  $filter.loc   ==   0 OR $filter.type  == 14 }<li><a class="bo"  href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterLoc&amp;category=0"    title="Unbekannt"           ><img src="img/svg/Ua.svg" width="32" height="32"/></a>
    {else}                                                <li><a class="bo"  href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterState&amp;category=0"  title="Alle SemApp"         ><img src="img/svg/Xa.svg" width="32" height="32"/></a>
    {/if}
    ...
    <ul>
      ...
      <li><a href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterType&amp;category=99"  title="Erwerbungsvorschlag" ><img src="img/svg/Ka.svg" width="24" height="24"/><span style="position:absolute; padding:12px;"> Erwerbungsvorsch.  </span></a></li>
      <li><a href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterLoc&amp;category=0"    title="Unbekannt"           ><img src="img/svg/Ua.svg" width="24" height="24"/><span style="position:absolute; padding:12px;"> Unbekannte M.      </span></a></li>
