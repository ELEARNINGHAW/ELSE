...
<ul id="nav2" style="position:absolute; right:77px;   top:3px;">
    ...
    {elseif  $filter.type == 16}<li><a href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterState&amp;category=9" title="Erwerbungsvorschlag" ><img src="img/svg/EV.svg" width="32" height="32"/></a>
    ...
    <ul>
      ...
      <li><a href="index.php?item=collection&amp;action=show_media_list&amp;mode=filterState&amp;category=9" title="Erwerbungsvorschlag" ><img src="img/svg/EV.svg" width="24" height="24"/><span style="position:absolute; padding:12px;"> Erwerbungsvorsch.  </span></a></li>
